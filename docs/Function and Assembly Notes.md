...
- I create a splice point inline when I have a bunch of wires all going to the same place.  Just twist them together using a modified [linemans splice](https://i1.wp.com/westcountyexplorersclub.com/wpwuwei/wp-content/uploads/2016/06/thumb-splice.png?resize=200%2C167) (simplified) with one wire exiting to solder to the termination point.  The appropriate piece of heat shrink tube tops it off nicely.
